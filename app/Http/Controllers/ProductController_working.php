...
class ProductController_working extends Controller
{
    /**
     * Show index page.
     */
    ...
    public function create()
    {
        ...
        return view('products.create', compact('categories','subcategories','subsubcategories'));
    }
    ...
    public function edit(Product $product)
    {
        ...
        return view('products.edit', compact('product','categories','subcategories','subsubcategories'));
    }
